...
router.post('/login', function(req, res, next) {
    ...
    connection.query("SELECT `keys`.`private_key` FROM `heroku_2f4d6f8d48f57a4`.`keys`", function (error, result, fields) {
      ...
      try{
        ...
        temp_pass = private_key.decrypt(`PttfGINuA1hhfK8A/m6vbhWTw2ca6MWguEBAEY7d/71tGPodhHS31BQat2I5/29zHfrI7987ThnAoClXCVJ09BNvlJOpQJmqt9iPtimAJ8JlCX3MQdaIu/GdQvETI429QBu2uT8rnZCDCYmwah0Qzpv8IQs9ChYoY2M0V0gTY=`, "utf8");
      }catch(err){
        console.log("error");
